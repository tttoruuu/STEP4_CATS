...
import { repeatAudioData, getRandomAudio } from '../../data/audioData';

export default function RepeatPracticeNew() {
  ...
  // 初期音声設定
  useEffect(() => {
    const randomAudio = getRandomAudio(repeatAudioData);
  ...
  const handleShowExamples = () => {
    // NG/OK例ページに遷移
    router.push({
      pathname: '/conversation/repeat-examples',
      query: { 
        ...
        <div className="flex-1 flex flex-col items-center px-6 py-4">
          <div className="w-full max-w-md">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 mb-6 shadow-sm border border-white/40">
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-600 text-sm mb-3">
                  相手の話をそのまま繰り返して、しっかり聞いていることを示しましょう
                </p>
                ...
                <div className="mt-3 bg-green-50 p-3 rounded-lg">
                  <h4 className="font-medium text-green-800 mb-2">注目すべきキーワード:</h4>
                  <div className="flex flex-wrap gap-2">
                    {currentAudio.keyWords.map((keyword, index) => (
            ...
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-3">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                  currentStep === 'listening' ? 'bg-green-600 text-white' : 'bg-green-200 text-green-600'
                }`}>
                  1
                </div>
            ...
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-3">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                  currentStep === 'recording' || currentStep === 'completed' ? 'bg-green-600 text-white' : 'bg-green-200 text-green-600'
                }`}>
                  2
                </div>
                <span className="font-semibold text-gray-800">相手の話を繰り返す</span>
              </div>
              ...
              {currentStep !== 'listening' && (
                <div className="mt-3 p-3 bg-blue-50 rounded-lg">
                  <p className="text-sm text-blue-700">
                    <strong>参考例:</strong> {currentAudio.correctRepeat}
                  </p>
                </div>
              )}
            </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl px-6 py-2 hover:opacity-90"
                    >
                      次の練習
                    </button>
