      ...
      <div className="flex flex-col min-h-screen bg-gradient-to-br from-pink-50 to-pink-100">
        <div className="w-full max-w-md mx-auto mt-8 px-6 relative h-10">
          <button 
            ...
            className="text-pink-600 flex items-center gap-1 hover:opacity-80 transition-opacity absolute left-6 top-0"
          >
            <ArrowLeft size={18} />
            ...
            {hasPlayedAudio && !showCorrectAnswer && (
              <div className="mb-6">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-pink-500 to-pink-600 text-white rounded-xl px-6 py-3 hover:opacity-90 transition-all"
                >
                  正解を聞く
                </button>
              </div>
