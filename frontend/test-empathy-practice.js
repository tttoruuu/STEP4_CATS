// あいづち・共感練習モードのテストスクリプト
// 実行方法: node test-empathy-practice.js

const { empathyAudioData } = require('./data/audioData');

console.log('=== あいづち・共感練習モード データ検証 ===\n');

// データ構造の検証
console.log(`シナリオ数: ${empathyAudioData.length}`);
console.log('');

empathyAudioData.forEach((scenario, index) => {
